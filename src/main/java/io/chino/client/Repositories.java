...
public class Repositories extends ChinoBaseAPI{
    ...
    public Repositories(String hostUrl, Client clientInitialized){
    ...
    public GetRepositoriesResponse list(int offset) throws IOException, ChinoApiException {
        ...
        if(data!=null)
            return mapper.readValue(data, GetRepositoriesResponse.class);
    ...
    public Repository read(String repositoryId) throws IOException, ChinoApiException{
        ...
        if(data!=null)
            return mapper.readValue(data, GetRepositoryResponse.class).getRepository();
